...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-deep-raat selection:bg-kesar-gold/30 selection:text-ivory">
      <Navigation />
      
      <main>
        {/* Page 1: Landing Page Container */}
        <section>
          <Hero />
      ...
      {/* Footer */}
      <footer className="relative mt-40 border-t border-teak-border pt-20 pb-10">
        <LotusTile opacity={0.05} />
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
             <div className="col-span-2">
                <div className="flex items-center gap-2 mb-6">
                  <div className="w-8 h-8 rounded-full grad-cta" />
                  <span className="font-display text-2xl text-kesar-gold tracking-[2px] font-bold">RAGALENS</span>
                </div>
                <p className="text-mitti max-w-sm mb-8 leading-relaxed">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="w-10 h-10 rounded-full border border-teak-border flex items-center justify-center hover:border-kesar-gold text-mitti hover:text-kesar-gold cursor-pointer transition-all">
                    <Heart size={18} />
                  </div>
                </div>
             </div>
             <div>
                <h4 className="text-ivory font-bold mb-6 text-sm">Explore</h4>
                <ul className="space-y-4 text-mitti text-[13px]">
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Raga Archive</li>
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Maestro Recordings</li>
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Digital Mehfil</li>
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Community</li>
                </ul>
             </div>
             <div>
                <h4 className="text-ivory font-bold mb-6 text-sm">Resources</h4>
                <ul className="space-y-4 text-mitti text-[13px]">
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Learning Path</li>
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Guru Network</li>
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">Toolkit</li>
                   <li className="hover:text-kesar-gold cursor-pointer transition-colors">API Docs</li>
                </ul>
             </div>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-teak-border/30 gap-6">
             <span className="text-[11px] text-mitti tracking-[1px] uppercase">© 2026 RAGALENS — ALL RIGHTS RESERVED</span>
             <div className="flex gap-8 text-[11px] text-mitti tracking-[1px] uppercase">
                ...
                <span className="hover:text-kesar-gold cursor-pointer">Accessibility</span>
             </div>
          </div>
        </div>
      </footer>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <motion.div 
      whileHover={{ y: -8 }}
      className="mughal-card p-10 group cursor-default"
    >
